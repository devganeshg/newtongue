...
Newtongue runs entirely on your own machine and doesn't handle authentication, payments, or
...
[Security tab](https://github.com/devganeshg/newtongue/security) →
...
Newtongue doesn't yet maintain multiple release branches — security fixes are made against the
